...
const Taletimeb4read2 = () => {
  const navigation = useNavigation();
  const { user } = useGlobalContext();
  const courseId = 'taletimeCourse';
  const lessonId = 'taletimeb4read2';
    ...
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.container}>
        ...
        <View style={styles.lessonContainer}>
          ...
          <Text style={styles.title2}>The Forgotten Garden</Text>
          <Image source={designs.bookvine} style={styles.treeImage} />

            <Link href="/taletimeCourse/taletimeLesson3" style={styles.nextButton}>
...
export default Taletimeb4read2