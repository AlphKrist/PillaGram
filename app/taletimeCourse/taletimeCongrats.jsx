    ...
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.container}>
        ...
        <View style={styles.lessonContainer}>
          ...
          <Text style={styles.title2}>For completing TaleTime!</Text>
          <Image source={designs.dolphin} style={styles.treeImage} />
...
export default TaletimeCongrats
