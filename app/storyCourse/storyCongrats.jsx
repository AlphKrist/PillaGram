    ...
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.container}>
        ...
        <View style={styles.lessonContainer}>
          ...
          <Text style={styles.title2}>For completing Story!</Text>
          <Image source={designs.bookpink} style={styles.treeImage} />
